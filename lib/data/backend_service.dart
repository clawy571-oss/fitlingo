  ...
  static List<SocialPost> _seedPosts() {
    ...
    return [
      SocialPost(
        id: '101',
        author: 'Nina',
        caption: '10 clean reps before class. Small wins add up.',
        imageUrl: 'https://picsum.photos/id/64/1000/700',
      ...
      SocialPost(
        id: '102',
        author: 'Mia',
        caption: '20 reps complete. Four focused sets.',
        imageUrl: 'https://picsum.photos/id/433/1000/700',
        ...
        comments: [
          SocialComment(
            id: 'c2',
            author: 'Arjun',
            message: 'Form looks sharp.',
            createdAt: now.subtract(const Duration(minutes: 28)),
          ),
          SocialComment(
            id: 'c3',
            author: 'Sara',
            message: 'I am using your pacing tomorrow.',
      ...
      SocialPost(
        id: '103',
        author: 'Theo',
        caption: 'Quick morning set done before breakfast.',
        imageUrl: 'https://picsum.photos/id/823/1000/700',
